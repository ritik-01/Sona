...
<html lang="en">
  ...
  <form class="form-inline" action="searchroom.php" method="post">
    <input class="form-control mr-auto" type="search" name="search" placeholder="Enter Room" aria-label="Search" style="margin-left:1350px;" >
